# asset-path-resolution Specification

## Purpose
Ensures consistent asset path conventions across all source HTML and a build pipeline that normalizes both absolute and bare relative asset paths.
